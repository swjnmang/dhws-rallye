...
export const FLOORS: Floor[] = [
  { id: "eg", name: "Erdgeschoss", imagePath: "/floors/erdgeschoss.svg", order: 0 },
  { id: "og1", name: "1. Obergeschoss", imagePath: "/floors/1-og.svg", order: 1 },
  { id: "og2", name: "2. Obergeschoss", imagePath: "/floors/2-og.svg", order: 2 },
];
